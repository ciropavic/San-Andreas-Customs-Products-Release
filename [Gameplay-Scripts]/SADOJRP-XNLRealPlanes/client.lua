...
--========================================================================
GPWS_Volume = 0.2								-- Setting: The Volume for GPWS and TCAS (Ground Proximity Warning System) and (Traffic Collision Avoidance System)
GPWS_LoopAlarmVolume = 0.2						-- Setting: The volume for the looped alarms (fire, Total TCAS Failure etc)
...
XNL_GlideSlopeRadius = 230.0					-- The Detection Radius per radius (every landingstrip has 4 to 5 of them), increade to make detection sooner, decrease if they are conflicting to much (planes suddenly going to the runway next to it)
