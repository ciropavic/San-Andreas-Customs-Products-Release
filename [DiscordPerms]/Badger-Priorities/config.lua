Config = {
	...
	Options = {
		...
		AlwaysDisplay = false, -- Always display the priority cooldown text even with 0 mins left?
	...
	Messages = {
		CooldownMessage = 'A priority was just conducted... The cooldown has been activated for ^1{MINS} ~w~mins ' -- You can also use {MINS} parameter here
