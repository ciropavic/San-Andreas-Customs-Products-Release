...
var guildId = "981586205906981014"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "MTAwNTU5OTE4ODk5MTYyNzMzNQ.GrCndB.wCex8WRiFPYdUelR3lOz-6Ba11lfZ57Xfg5Jrw"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
var noGuildMessage = "Discord Not Detected. It seems you're not in the discord for this community. Please join HERE! (Then reconnect.) --> https://discord.gg/n6384P4TrX <--";
var blacklistMessage = "You're blacklisted from this server.";
var debugMode = false; // 
var cacheMaxTime = "15s"; // This is the time it takes for refreshes (cache) to have to reload when fetching Discord roles.
